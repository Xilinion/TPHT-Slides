...
\begin{frame}[t]{Ingredient 1: Tiny Pointer}
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,>={Latex[length=1.6mm,width=1.0mm]},every node/.style={font=\normalsize}]
    ...
    \path[use as bounding box] (-6.08,-1.10) rectangle (1.80,2.38);
    ...
    \node[font=\large\bfseries,CornellRed] at (-4.37,0.98) {return \(p_2\)};
    \node[draw=Green,fill=Green!8,rounded corners=2pt,
          anchor=west,minimum width=3.25cm,minimum height=0.52cm,font=\normalsize\bfseries] (deref) at (-6.00,0.43)
      {\apiop{Deref}{\text{Alice}, p_1}};
    \node[font=\large\bfseries,Green!65!black] at (-4.37,-0.14) {return Bob};
    \node[draw=Purple,fill=Purple!8,rounded corners=2pt,
          anchor=west,minimum width=3.25cm,minimum height=0.52cm,font=\normalsize\bfseries] (free) at (-6.00,-0.69)
    ...
    \draw[Green,line width=0.9pt,rounded corners=2pt,fill=Green!6]
      (-0.75,0.94) rectangle (1.55,1.46);
    \draw[Green,line width=0.7pt] (0.75,0.94) -- (0.75,1.46);
    \node[Green,font=\normalsize\bfseries] (aobj) at (0.02,1.20) {Alice};
    \node[Green,font=\normalsize\bfseries] (aptr) at (1.20,1.20) {\(p_1\)};

    \draw[Ink,line width=0.9pt,rounded corners=2pt,fill=Green!8]
      (-0.75,0.04) rectangle (0.75,0.56);
    \draw[CornellRed,dashed,line width=0.9pt,rounded corners=2pt,fill=CornellRed!7]
      (0.75,0.04) rectangle (1.55,0.56);
    \node[Green,font=\normalsize\bfseries] (bobj) at (0.02,0.30) {Bob};
    \node[CornellRed,font=\normalsize\bfseries] (bptr) at (1.20,0.30) {\(p_2\)};

    \draw[CornellRed,dashed,line width=0.9pt,rounded corners=2pt,fill=CornellRed!7]
      (-0.75,-0.86) rectangle (1.55,-0.34);
    \draw[CornellRed,dashed,line width=0.7pt] (0.75,-0.86) -- (0.75,-0.34);
    \node[CornellRed,font=\normalsize\bfseries] (cobj) at (0.02,-0.60) {Carol};
    \node[CornellRed,font=\normalsize\bfseries] (cptr) at (1.20,-0.60) {\(\bot\)};

    \draw[-{Latex[length=1.35mm,width=0.90mm]},Green,line width=0.85pt]
      (1.20,0.94) -- (1.20,0.58);
    \draw[-{Latex[length=1.35mm,width=0.90mm]},CornellRed,dashed,line width=0.85pt]
      (1.20,0.04) -- (1.20,-0.32);

    \coordinate (bobwest) at (-0.75,0.30);
    \coordinate (carolwest) at (-0.75,-0.60);
