...
\begin{frame}{Making TPHT Fast}
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,>=Latex,every node/.style={font=\small}]
    ...
    \node[font=\normalsize\bfseries] (oldhead) at (-2.97,-0.02) {\(p_q\)};
    \node[draw=Ink,fill=white,line width=0.8pt,rounded corners=2pt,
          minimum width=2.15cm,minimum height=0.58cm,font=\normalsize\bfseries] (oldnode) at (1.62,-0.02)
      {\(r_1,v_1\mid p_2\)};
    ...
    \node[font=\normalsize\bfseries,text=CornellRed] at (-2.84,-1.31) {\(r_1,v_1\)};
    \node[font=\normalsize\bfseries] (nextp) at (-1.32,-1.31) {\(p_2\)};
    \node[draw=Ink,fill=white,line width=0.8pt,rounded corners=2pt,
          minimum width=1.52cm,minimum height=0.52cm,font=\normalsize\bfseries] (nextnode) at (1.05,-1.31)
      {\(r_2,v_2\)};
...
\begin{frame}{Making TPHT Fast: Chain Walks}
  ...
  \begin{center}
  \begin{tikzpicture}[x=1cm,y=1cm,>=Latex,every node/.style={font=\small}]
    \node[font=\normalsize\bfseries,text=BlueGray] at (-3.85,1.40) {naive extension};
    \node[font=\normalsize\bfseries,text=BlueGray] at (2.30,1.40) {shared cache-line block};
