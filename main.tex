...
\begin{frame}{What is a good hash table?}
  \begin{columns}[T,onlytextwidth]
    \column{0.58\textwidth}
      \vspace{0.02cm}
      {\large\raggedright
        \textcolor{CornellRed}{\LARGE\textbf{Throughput}}: $\displaystyle\frac{\text{\# operations}}{\text{time}}$\par
        \vspace{0.06cm}
        \textcolor{CornellRed}{\LARGE\textbf{Space efficiency}}: $\displaystyle\frac{\text{data size}}{\text{memory footprint}}$
      }\par
      \vspace{0.04cm}
      \begin{center}
  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.47\textwidth}
      ...
      \begin{enumerate}\large
        \item \textbf{Heads stay in cache}\\[-1pt]
          {\normalsize the head array is
           \textcolor{CornellRed}{\textbf{\(8\times\)}} smaller}
          \vspace{0.18cm}
        \item \textbf{Smaller key storage}\\[-1pt]
          {\normalsize we keep only the remainder \(r\)}
          \vspace{0.18cm}
        \item \textbf{Shorter chains}\\[-1pt]
          {\normalsize cheap heads buy more buckets}
      \end{enumerate}
      \vspace{0.34cm}
      \centering
      \begin{tikzpicture}
    ...
    \column{0.50\textwidth}
      ...
      \begin{tikzpicture}[x=1cm,y=1cm,
          ...
          mline/.style={line width=1.7pt,Ink!62},
          merge/.style={-{Latex[length=3.4mm,width=2.8mm]},line width=1.7pt,Ink!62},
          ...
          beforetag/.style={fill=CornellRed,text=white,rounded corners=2pt,
                           inner xsep=7pt,inner ysep=3pt,font=\large\bfseries},
          aftertag/.style={fill=Green!88!black,text=white,rounded corners=2pt,
                          inner xsep=7pt,inner ysep=3pt,font=\large\bfseries},
          div/.style={Ink!35,line width=0.7pt},
          fld/.style={font=\large\bfseries},
          tag/.style={anchor=north west,font=\normalsize,text=BlueGray}]

        % ===================== BEFORE =====================================
        \node[anchor=east,font=\small,text=BlueGray] at (3.15,2.10)
          {one chain in the hash table};
        \draw[beforepanel] (-3.15,0.08) rectangle (3.15,1.84);
        \node[beforetag,anchor=west] at (-3.05,2.24) {Before};

        \node[anchor=south,font=\large\bfseries,text=CornellRed] at (-1.47,1.32)
          {inevitable hop};

        \draw[box,Green,fill=Green!20] (-3.01,0.76) rectangle (-2.31,1.30);
        \node[fld] at (-2.66,1.03) {\(p\)};
        \node[tag] at (-3.01,0.66) {head array};

        \draw[flow,CornellRed] (-2.31,1.03) -- (-0.63,1.03);

        \fill[Purple!20] (-0.63,0.76) rectangle (0.47,1.30);
        \draw[box,Ink!75] (-0.63,0.76) rectangle (1.02,1.30);
        \draw[div] (-0.08,0.76) -- (-0.08,1.30);
        \draw[div] (0.47,0.76) -- (0.47,1.30);
        \node[fld] at (-0.355,1.03) {\(r\)};
        \node[fld] at (0.195,1.03) {\(v\)};
        \node[fld] at (0.745,1.03) {\(p'\)};
        \node[tag] at (-0.63,0.66) {first tuple};

        \draw[flow,Ink] (1.02,1.03) -- (1.36,1.03);
        \draw[box,Ink!75,fill=white] (1.36,0.76) rectangle (3.01,1.30);
        \draw[div] (1.91,0.76) -- (1.91,1.30);
        \draw[div] (2.46,0.76) -- (2.46,1.30);
        \node[fld] at (1.635,1.03) {\(r'\)};
        \node[fld] at (2.185,1.03) {\(v'\)};
        \node[fld] at (2.735,1.03) {\(\bot\)};

        % ===================== the merge ==================================
        \draw[mline] (-2.66,0.04) to[out=-80,in=158] (-1.40,-0.30);
        \draw[mline] (-0.08,0.04) to[out=-100,in=22] (-1.40,-0.30);
        \draw[merge] (-1.40,-0.30) -- (-1.40,-0.90);
        \node[anchor=west,font=\large\bfseries,text=Ink] at (-1.26,-0.40) {merge};

        % ===================== AFTER ======================================
        \draw[afterpanel] (-3.15,-2.16) rectangle (3.15,-0.98);
        \node[aftertag,anchor=west] at (-3.05,-0.80) {After};

        \fill[Purple!20] (-3.01,-1.62) rectangle (-1.91,-1.08);
        \draw[box,Green] (-3.01,-1.62) rectangle (-1.36,-1.08);
        \draw[div] (-2.46,-1.62) -- (-2.46,-1.08);
        \draw[div] (-1.91,-1.62) -- (-1.91,-1.08);
        \node[fld] at (-2.735,-1.35) {\(r\)};
        \node[fld] at (-2.185,-1.35) {\(v\)};
        \node[fld] at (-1.635,-1.35) {\(p'\)};
        \node[tag] at (-3.01,-1.72) {head array};

        \draw[flow,Ink] (-1.36,-1.35) -- (-1.02,-1.35);
        \draw[box,Ink!75,fill=white] (-1.02,-1.62) rectangle (0.63,-1.08);
        \draw[div] (-0.47,-1.62) -- (-0.47,-1.08);
        \draw[div] (0.08,-1.62) -- (0.08,-1.08);
        \node[fld] at (-0.745,-1.35) {\(r'\)};
        \node[fld] at (-0.195,-1.35) {\(v'\)};
        \node[fld] at (0.355,-1.35) {\(\bot\)};

        % ===================== payoff =====================================
        \node[draw=Gold,fill=Gold!22,line width=2.0pt,rounded corners=6pt,
              inner xsep=9pt,inner ysep=5pt,font=\large\bfseries,text=Ink,rotate=-3]
              at (0,-2.74) {One fewer cache miss!};
      \end{tikzpicture}
      \end{center}
  \end{columns}
